...
describe('orchestrator + ranking + fallback', () => {
  ...
  it('resolves the five MVP examples end to end when enabled', () => {
    const cases: Array<[CommerceRequest, { url?: string; subjectRef?: string }, string, number]> = [
      ...
      [{ domain: 'food_drink', intentType: 'reserve_table', subject: 'x', configuration: { kind: 'reservation', restaurantRef: '4815', date: '2026-09-13', time: '19:00', adults: 2 } }, { subjectRef: '4815' }, 'pasgo', 5],
