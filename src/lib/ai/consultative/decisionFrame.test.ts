...
describe('PROVENANCE — atmosphere and quality adjectives need text about the place', () => {
  ...
  // 🔶 OVERNIGHT 2026-09-17 (STEP C-2): skipped, not deleted. Depends on the cool-vaughan rewrite of
  // placeClaimGuard (adjective provenance) which was NOT merged — the G1 attribution ladder (owner-
  // approved 2026-09-17) is the merged guard. Candidate for STEP E (evidence-only attributes).
  it.skip('the measured embellishments go; the wifi fact and the name stay', () => {
