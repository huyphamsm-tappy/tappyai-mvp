...
==========================================`
  ...
  const wordLimitBlock = isFirstReply
    ? `\n\n===== WORD LIMIT - REPLY DAU TIEN =====\nDay la reply DAU TIEN trong conversation. GIOI HAN: toi da 150 tu (chi tinh van ban CHU hien thi cho user - KHONG tinh block [CTA_BUTTONS]...[/CTA_BUTTONS] la ma may tinh). Anh, link review TikTok va link dat do HE THONG tu chen - ban KHONG viet nen khong lo vuot gioi han. Viet ngan, chon loc, de hieu. Cau cuoi phai la follow-up question.\n==========================================`
    : `\n\n===== WORD LIMIT - CO CONTEXT =====\nUser da tra loi follow-up. Duoc phep reply chi tiet hon, toi da 250 tu (chi tinh van ban CHU hien thi - KHONG tinh block [CTA_BUTTONS]...[/CTA_BUTTONS] la ma may tinh). Anh, link review TikTok va link dat do HE THONG tu chen - ban KHONG viet. Nhung van phai ngan gon, khong viet bao cao. Cau cuoi van nen co follow-up question neu con thong tin can lam ro.\n==========================================`
...
5) ANH, LINK REVIEW & LINK DAT — HE THONG TU CHEN, BAN KHONG VIET: Anh dai dien (photo_urls/photo_url), dong review TikTok (tiktok_url), va cac link dat/website (order_links / platform_links) se do HE THONG tu dong chen ngay sau ten & mo ta tung dia diem. TUYET DOI KHONG tu viet cac dong \`![Ảnh địa điểm](...)\`, \`🎵 [Xem review TikTok](...)\`, hay cac link dat/website ([ShopeeFood]/[GrabFood]/[BeFood]/[Official Website]/[Google Maps]) trong phan van ban. Ban CHI viet phan CHU cho tung dia diem: ten (in dam) + rating + dia chi + mo ta ngan + thong tin huu ich. Viet gon giup reply day du, khong bi cat cut.
