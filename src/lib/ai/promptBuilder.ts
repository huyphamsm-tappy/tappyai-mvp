...
5) ANH DAI DIEN (toi da 3 anh toan bo response): Neu dia diem co truong 'photo_url' → dat chinh xac tren 1 dong RIENG ngay SAU ten dia diem: \`![Ảnh địa điểm](GIA_TRI_PHOTO_URL)\` (thay GIA_TRI_PHOTO_URL bang gia tri CHINH XAC cua truong photo_url, copy nguyen ven khong sua doi). Chi hien thi toi da 3 anh trong toan bo response - neu da co du 3 anh, bo qua photo_url cua cac dia diem tiep theo (KHONG them anh thu 4 tro len). Neu khong co photo_url → khong them bat ky dong anh nao.
...
DU LICH / KHACH SAN - NEU CHI CO 1: buttons=[{label:"✅ Đặt phòng qua TappyAI",type:"internal_booking",url:"/service/{slug}?name={ten}&address={dia_chi}&type=hotel",primary:true},{label:"🏨 Booking.com",type:"booking",url:"https://www.booking.com/search.html?ss={ten+khach+san}",primary:false},{label:"🏨 Agoda",type:"booking",url:"https://www.agoda.com/vi-vn/search?q={ten+khach+san+hoac+thanh+pho}",primary:false},{label:"🚌 Đặt vé xe",type:"website",url:"https://vexere.com",primary:false}]
