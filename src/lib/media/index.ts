...
/**
 * Production credential wiring is intentionally absent: no service-account
 * key exists yet, so the GCS provider is constructed with a null token source
 * and will throw MediaCredentialsUnavailableError on write.
 */
