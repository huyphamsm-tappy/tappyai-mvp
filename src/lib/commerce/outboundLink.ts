...
import { linkDepthClass, type LinkDepthClass } from './linkDepth'

// The depth judgement itself is in ./linkDepth — a module with no imports — because the client
// (ctaValidation ← ChatInterface) needs it and this module's imports above are server-only.
// Re-exported so server callers keep one import site.
export { linkDepthClass, type LinkDepthClass }
