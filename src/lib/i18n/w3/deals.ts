...
export const vi: Record<string, string> = {
  ...
  'deals.voucherLabel': 'Mã',
  'deals.copyCode': 'Sao chép mã',
  'deals.codeCopied': 'Đã sao chép!',
...
export const en: Record<string, string> = {
  ...
  'deals.daysLeft': '{count} days left',
  'deals.endingSoon': '🔥 Ending Soon',
  'deals.voucherLabel': 'Code',
  'deals.copyCode': 'Copy code',
  'deals.codeCopied': 'Copied!',
