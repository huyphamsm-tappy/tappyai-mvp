...
export const vi: Record<string, string> = {
  ...
  'deals.notifyOn': 'Đã bật thông báo deal hàng ngày',
  'deals.notifyDenied': 'Thông báo bị chặn trong cài đặt trình duyệt',
  'deals.notifyCta': 'Nhận deal hàng ngày lúc 7:30',
...
export const en: Record<string, string> = {
  ...
  'deals.notifyOn': 'Daily deal notifications on',
  'deals.notifyDenied': 'Notifications blocked in browser settings',
  'deals.notifyCta': 'Get daily deals at 7:30 AM',
