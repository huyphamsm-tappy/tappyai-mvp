...
export const vi: Record<string, string> = {
  ...
  'reviews.commentReply': 'Trả lời',
  'reviews.commentReplyingTo': 'Đang trả lời {name}',
  'reviews.commentCancelReply': 'Huỷ',
  'reviews.commentReact': 'Cảm xúc',
  'reviews.commentViewReplies': 'Xem {n} trả lời',
  'reviews.commentHideReplies': 'Ẩn trả lời',
...
export const en: Record<string, string> = {
  ...
  'reviews.commentReply': 'Reply',
  'reviews.commentReplyingTo': 'Replying to {name}',
  'reviews.commentCancelReply': 'Cancel',
  'reviews.commentReact': 'React',
  'reviews.commentViewReplies': 'View {n} replies',
  'reviews.commentHideReplies': 'Hide replies',
