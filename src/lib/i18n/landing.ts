...
export const en: Record<string, string> = {
  ...
  'landing.shots.translate.label': 'Instant translate',
  'landing.shots.translate.alt': 'TappyAI instant translation screen supporting 30 languages',
  'landing.shots.scan.label': 'Scan documents',
  'landing.shots.scan.alt': 'TappyAI document scanner that extracts text from a photo with AI',
  'landing.shots.split.label': 'Split the bill',
  'landing.shots.split.alt': 'TappyAI bill-splitting tool with tip presets and even or by-item split',
...
export const vi: Record<string, string> = {
  ...
  'landing.shots.translate.label': 'Dịch tức thì',
  'landing.shots.translate.alt': 'Màn hình dịch tức thì TappyAI hỗ trợ 30 ngôn ngữ',
  'landing.shots.scan.label': 'Quét tài liệu',
  'landing.shots.scan.alt': 'Trình quét tài liệu TappyAI trích xuất văn bản từ ảnh bằng AI',
  'landing.shots.split.label': 'Chia tiền',
  'landing.shots.split.alt': 'Công cụ chia hóa đơn TappyAI với tùy chọn tip và chia đều hoặc theo món',
