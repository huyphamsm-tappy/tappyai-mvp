...
export const vi: Record<string, string> = {
  ...
  'v3.nav.scamShield': 'Cảnh báo lừa đảo',
  'v3.nav.inbox': 'Inbox',
  ...
  'v3.panel.scamShield': 'Cảnh báo lừa đảo',
  ...
  // Explore public profile (/users/[id]) — what a member shows the community.
  'v3.publicProfile.title': 'Trang cá nhân',
  'v3.publicProfile.posts': 'Bài đăng',
  'v3.publicProfile.followers': 'Người theo dõi',
  'v3.publicProfile.following': 'Đang theo dõi',
  'v3.publicProfile.edit': 'Chỉnh sửa hồ sơ',
  'v3.publicProfile.contentAria': 'Nội dung công khai',
  'v3.publicProfile.tabPosts': 'Bài đăng',
  'v3.publicProfile.tabShares': 'Chia sẻ',
  'v3.publicProfile.emptyPosts': 'Chưa có bài đăng nào.',
  'v3.publicProfile.emptyShares': 'Chưa có nội dung chia sẻ.',
  'v3.publicProfile.tabLiked': 'Đã thích',
  'v3.publicProfile.tabSaved': 'Đã lưu',
  'v3.publicProfile.tabHidden': 'Đã ẩn',
  'v3.publicProfile.emptyLiked': 'Bạn chưa thích bài nào.',
  'v3.publicProfile.emptySaved': 'Bạn chưa lưu bài nào.',
  'v3.publicProfile.emptyHidden': 'Không có bài nào đang ẩn.',
  'v3.publicProfile.privateNote': 'Chỉ mình bạn thấy mục này.',
  'v3.publicProfile.tabError': 'Không tải được mục này.',
  'v3.publicProfile.retry': 'Thử lại',
  'v3.publicProfile.hidePost': 'Ẩn bài',
  'v3.publicProfile.showPost': 'Hiện lại',
  'v3.publicProfile.coverAlt': 'Ảnh bìa',
  'v3.publicProfile.coverChange': 'Thay ảnh bìa',
  'v3.publicProfile.coverRemove': 'Gỡ ảnh bìa',
  'v3.publicProfile.coverUploading': 'Đang tải ảnh bìa…',
  'v3.publicProfile.coverErrTooLarge': 'Ảnh bìa tối đa 5MB',
  'v3.publicProfile.coverErrNotImage': 'Chỉ chấp nhận file ảnh',
  'v3.publicProfile.coverErrUpload': 'Không thể cập nhật ảnh bìa. Vui lòng thử lại.',
  ...
  'v3.history.linksDesc': 'Các đường link bạn đã kiểm tra qua Cảnh báo lừa đảo.',
  ...
  // Analyze Message — the third tab. Level names reuse `scamShield.result.*`.
  'v3.scam.tabMessage': 'Phân tích tin nhắn',
  'v3.scam.msg.title': 'Phân tích tin nhắn',
  'v3.scam.msg.subtitle': 'Dán tin nhắn hoặc mô tả tình huống đáng ngờ. AI sẽ phân tích nội dung và các dấu hiệu lừa đảo.',
  'v3.scam.msg.placeholder': 'Ví dụ: Một người tự xưng là nhân viên ngân hàng gọi cho tôi và yêu cầu chuyển tiền để xác minh tài khoản…',
  'v3.scam.msg.urlPlaceholder': 'Liên kết kèm theo (không bắt buộc)',
  'v3.scam.msg.upload': 'Tải ảnh chụp màn hình',
  'v3.scam.msg.removeScreenshot': 'Bỏ ảnh',
  'v3.scam.msg.cta': 'Phân tích ngay',
  'v3.scam.msg.analyzing': 'Đang phân tích…',
  'v3.scam.msg.quotaHint': 'Mỗi lần phân tích dùng 1 lượt hỏi AI chung của Tappy (khách: {a} lượt dùng thử, tài khoản: {n} lượt/ngày). Kiểm tra liên kết và quét QR không tính vào lượt.',
  'v3.scam.msg.errFailed': 'Chưa phân tích được tin nhắn này. Vui lòng thử lại.',
  'v3.scam.msg.errImage': 'Ảnh không hợp lệ hoặc quá lớn (tối đa 5 MB, JPEG/PNG/WebP).',
  'v3.scam.msg.why': 'Vì sao đáng ngờ',
  'v3.scam.msg.goal': 'Kẻ gian muốn lấy gì',
  'v3.scam.msg.wants': 'Tin nhắn yêu cầu bạn',
  'v3.scam.msg.doNot': 'KHÔNG làm',
  'v3.scam.msg.doNow': 'Nên làm ngay',
  'v3.scam.msg.links': 'Liên kết trong tin nhắn',
  'v3.scam.msg.linkUnchecked': 'Chưa kiểm tra được',
  'v3.scam.msg.extracted': 'Nội dung đọc từ ảnh',
  'v3.scam.msg.aiUsed': 'Kết quả kết hợp kiểm tra liên kết, quy tắc nhận diện và phân tích AI.',
  'v3.scam.msg.aiNotNeeded': 'Tin nhắn chỉ chứa liên kết — kết quả là kết quả kiểm tra liên kết, không dùng lượt AI.',
  'v3.scam.msg.aiQuota': 'Bạn đã dùng hết lượt hỏi AI ({used}/{n} {period}). Kết quả này chỉ dựa trên kiểm tra liên kết và quy tắc nhận diện.',
  'v3.scam.msg.aiQuotaGuest': 'Đăng nhập để có {n} lượt hỏi AI mỗi ngày.',
  'v3.scam.msg.aiLeft': 'AI còn lại: {remaining}/{n}',
  'v3.scam.msg.aiToday': 'AI hôm nay: {used}/{n}',
  'v3.scam.msg.aiPro': 'Tài khoản Pro — không giới hạn.',
  'v3.scam.msg.aiUnavailable': 'Phân tích AI tạm không khả dụng. Kết quả này chỉ dựa trên kiểm tra liên kết và quy tắc nhận diện.',
  'v3.scam.msg.aiFailed': 'AI không trả về kết quả dùng được. Kết quả này dựa trên kiểm tra liên kết và quy tắc nhận diện.',
  'v3.scam.msg.perDay': 'hôm nay',
  'v3.scam.msg.perLifetime': 'dùng thử',
  // Scam pattern names (`ScamType`).
  'v3.scam.msg.type.telegram_account_phishing': 'Lừa chiếm tài khoản Telegram',
  'v3.scam.msg.type.bank_phishing': 'Giả mạo ngân hàng',
  'v3.scam.msg.type.government_impersonation': 'Giả danh cơ quan nhà nước / công an',
  'v3.scam.msg.type.delivery_scam': 'Lừa đảo giao hàng',
  'v3.scam.msg.type.ecommerce_refund_scam': 'Lừa hoàn tiền mua sắm',
  'v3.scam.msg.type.prize_scam': 'Lừa trúng thưởng',
  'v3.scam.msg.type.investment_scam': 'Lừa đảo đầu tư',
  'v3.scam.msg.type.otp_phishing': 'Lừa lấy mã OTP',
  'v3.scam.msg.type.remote_access_scam': 'Lừa điều khiển thiết bị từ xa',
  'v3.scam.msg.type.malware_distribution': 'Phát tán ứng dụng độc hại',
  'v3.scam.msg.type.romance_scam': 'Lừa đảo tình cảm',
  'v3.scam.msg.type.job_scam': 'Lừa đảo việc làm',
  'v3.scam.msg.type.tech_support_scam': 'Giả mạo hỗ trợ kỹ thuật',
  'v3.scam.msg.type.customer_support_impersonation': 'Giả mạo chăm sóc khách hàng',
  'v3.scam.msg.type.loan_scam': 'Lừa đảo vay tiền',
  'v3.scam.msg.type.charity_scam': 'Lừa đảo từ thiện',
  'v3.scam.msg.type.other': 'Dấu hiệu lừa đảo khác',
  // Attack goals (`AttackGoal`).
  'v3.scam.msg.goal.account_takeover': 'Chiếm đoạt tài khoản của bạn',
  'v3.scam.msg.goal.credential_theft': 'Đánh cắp thông tin đăng nhập',
  'v3.scam.msg.goal.otp_interception': 'Lấy mã OTP của bạn',
  'v3.scam.msg.goal.payment_fraud': 'Lừa bạn chuyển tiền',
  'v3.scam.msg.goal.identity_theft': 'Đánh cắp thông tin cá nhân',
  'v3.scam.msg.goal.malware_installation': 'Cài phần mềm độc hại lên thiết bị',
  'v3.scam.msg.goal.remote_access_compromise': 'Điều khiển thiết bị của bạn từ xa',
  'v3.scam.msg.goal.phishing': 'Dụ bạn vào trang giả mạo',
  'v3.scam.msg.goal.social_engineering': 'Thao túng để bạn làm theo yêu cầu',
  'v3.scam.msg.goal.investment_scam': 'Dụ bạn nạp tiền đầu tư',
  'v3.scam.msg.goal.romance_scam': 'Lợi dụng tình cảm để lấy tiền',
  'v3.scam.msg.goal.impersonation': 'Mạo danh để tạo lòng tin',
  'v3.scam.msg.goal.other': 'Mục đích khác',
  // Official anti-fraud knowledge library. Scenario CONTENT lives in lib/scam-shield/knowledge (Vietnamese,
  // source-derived); these are the chrome strings only.
  'v3.scam.kb.title': 'Kiến thức chống lừa đảo',
  'v3.scam.kb.subtitle': 'Các tình huống lừa đảo phổ biến được tổng hợp từ nguồn chính thức.',
  'v3.scam.kb.all': 'Tất cả',
  'v3.scam.kb.official': 'Thông tin từ nguồn chính thức',
  'v3.scam.kb.source': 'Nguồn',
  'v3.scam.kb.openSource': 'Xem nguồn gốc',
  'v3.scam.kb.published': 'Đăng ngày',
  'v3.scam.kb.verifiedAt': 'TappyAI đối chiếu ngày',
  'v3.scam.kb.officialNumber': 'Kịch bản số {n} trong danh sách chính thức',
  'v3.scam.kb.guidance': 'Hướng dẫn của TappyAI',
  'v3.scam.kb.guidanceNote': 'Do TappyAI biên soạn dựa trên nội dung nguồn chính thức — không phải trích dẫn nguyên văn.',
  'v3.scam.kb.signs': 'Dấu hiệu nhận biết',
  'v3.scam.kb.requests': 'Kẻ gian thường yêu cầu',
  'v3.scam.kb.goal': 'Mục đích của kẻ gian',
  'v3.scam.kb.doNot': 'KHÔNG làm',
  'v3.scam.kb.doNow': 'Nên làm',
  'v3.scam.kb.prevention': 'Biện pháp phòng tránh (theo nguồn chính thức)',
  'v3.scam.kb.report': 'Khi phát hiện dấu hiệu lừa đảo',
  'v3.scam.kb.showMore': 'Xem thêm tình huống',
  'v3.scam.kb.showLess': 'Thu gọn',
  'v3.scam.kb.close': 'Đóng',
  'v3.scam.kb.count': '{n} tình huống',
  'v3.scam.kb.contentLanguage': '',
  'v3.scam.kb.cat.impersonation': 'Cơ quan nhà nước',
  'v3.scam.kb.cat.ai_deepfake': 'AI – Deepfake',
  'v3.scam.kb.cat.investment_jobs': 'Đầu tư, việc làm',
  'v3.scam.kb.cat.online_trading': 'Mua bán trực tuyến',
  'v3.scam.kb.cat.data_theft': 'Đánh cắp dữ liệu',
...
export const en: Record<string, string> = {
  ...
  'v3.panel.deals': 'Deals / Groupon',
  'v3.panel.marketplace': 'Marketplace',
  'v3.panel.scamShield': 'Scam Alerts',
  'v3.panel.planner': 'AI Planner (My Plans)',
  'v3.panel.post': 'Post / Upload',
  ...
  // Explore public profile (/users/[id]) — what a member shows the community.
  'v3.publicProfile.title': 'Profile',
  'v3.publicProfile.posts': 'Posts',
  'v3.publicProfile.followers': 'Followers',
  'v3.publicProfile.following': 'Following',
  'v3.publicProfile.edit': 'Edit profile',
  'v3.publicProfile.contentAria': 'Public content',
  'v3.publicProfile.tabPosts': 'Posts',
  'v3.publicProfile.tabShares': 'Shared',
  'v3.publicProfile.emptyPosts': 'No posts yet.',
  'v3.publicProfile.emptyShares': 'Nothing shared yet.',
  'v3.publicProfile.tabLiked': 'Liked',
  'v3.publicProfile.tabSaved': 'Saved',
  'v3.publicProfile.tabHidden': 'Hidden',
  'v3.publicProfile.emptyLiked': "You haven't liked any posts yet.",
  'v3.publicProfile.emptySaved': "You haven't saved any posts yet.",
  'v3.publicProfile.emptyHidden': 'No hidden posts.',
  'v3.publicProfile.privateNote': 'Only you can see this section.',
  'v3.publicProfile.tabError': "Couldn't load this section.",
  'v3.publicProfile.retry': 'Retry',
  'v3.publicProfile.hidePost': 'Hide post',
  'v3.publicProfile.showPost': 'Show again',
  'v3.publicProfile.coverAlt': 'Cover photo',
  'v3.publicProfile.coverChange': 'Change cover',
  'v3.publicProfile.coverRemove': 'Remove cover',
  'v3.publicProfile.coverUploading': 'Uploading cover…',
  'v3.publicProfile.coverErrTooLarge': 'Cover photos are limited to 5MB',
  'v3.publicProfile.coverErrNotImage': 'Only image files are accepted',
  'v3.publicProfile.coverErrUpload': "Couldn't update the cover. Please try again.",
  ...
  'v3.history.linksDesc': 'Links you have checked with Scam Alerts.',
  ...
  // Analyze Message — the third tab.
  'v3.scam.tabMessage': 'Analyze a message',
  'v3.scam.msg.title': 'Analyze a message',
  'v3.scam.msg.subtitle': 'Paste a message or describe a suspicious situation. AI will analyze the content and the scam signals.',
  'v3.scam.msg.placeholder': 'Example: Someone claiming to be a bank employee called me and asked me to transfer money to verify my account…',
  'v3.scam.msg.urlPlaceholder': 'Link included in the message (optional)',
  'v3.scam.msg.upload': 'Upload a screenshot',
  'v3.scam.msg.removeScreenshot': 'Remove screenshot',
  'v3.scam.msg.cta': 'Analyze now',
  'v3.scam.msg.analyzing': 'Analyzing…',
  'v3.scam.msg.quotaHint': 'Each analysis uses 1 of your shared Tappy AI questions (guests: {a} trial questions, accounts: {n} per day). Link checks and QR scans do not count.',
  'v3.scam.msg.errFailed': "Couldn't analyze this message. Please try again.",
  'v3.scam.msg.errImage': 'The image is not valid or too large (max 5 MB, JPEG/PNG/WebP).',
  'v3.scam.msg.why': 'Why it is suspicious',
  'v3.scam.msg.goal': 'What the attacker is after',
  'v3.scam.msg.wants': 'The message asks you to',
  'v3.scam.msg.doNot': 'Do NOT',
  'v3.scam.msg.doNow': 'Do this now',
  'v3.scam.msg.links': 'Links in the message',
  'v3.scam.msg.linkUnchecked': 'Could not check',
  'v3.scam.msg.extracted': 'Text read from the screenshot',
  'v3.scam.msg.aiUsed': 'This verdict combines the link checks, the detection rules and AI analysis.',
  'v3.scam.msg.aiNotNeeded': 'The message is only a link — this is the link check; no AI allowance was used.',
  'v3.scam.msg.aiQuota': "You've used all your AI questions ({used}/{n} {period}). This verdict rests on the link checks and the detection rules only.",
  'v3.scam.msg.aiQuotaGuest': 'Sign in for {n} AI questions every day.',
  'v3.scam.msg.aiLeft': 'AI left: {remaining}/{n}',
  'v3.scam.msg.aiToday': 'AI today: {used}/{n}',
  'v3.scam.msg.aiPro': 'Pro account — unlimited.',
  'v3.scam.msg.aiUnavailable': 'AI analysis is temporarily unavailable. This verdict rests on the link checks and the detection rules only.',
  'v3.scam.msg.aiFailed': 'The AI did not return a usable assessment. This verdict rests on the link checks and the detection rules.',
  'v3.scam.msg.perDay': 'today',
  'v3.scam.msg.perLifetime': 'trial',
  // Scam pattern names (`ScamType`).
  'v3.scam.msg.type.telegram_account_phishing': 'Telegram account takeover phishing',
  'v3.scam.msg.type.bank_phishing': 'Bank impersonation phishing',
  'v3.scam.msg.type.government_impersonation': 'Government / police impersonation',
  'v3.scam.msg.type.delivery_scam': 'Delivery scam',
  'v3.scam.msg.type.ecommerce_refund_scam': 'E-commerce refund scam',
  'v3.scam.msg.type.prize_scam': 'Prize / reward scam',
  'v3.scam.msg.type.investment_scam': 'Investment scam',
  'v3.scam.msg.type.otp_phishing': 'OTP phishing',
  'v3.scam.msg.type.remote_access_scam': 'Remote-access scam',
  'v3.scam.msg.type.malware_distribution': 'Malicious app distribution',
  'v3.scam.msg.type.romance_scam': 'Romance scam',
  'v3.scam.msg.type.job_scam': 'Job scam',
  'v3.scam.msg.type.tech_support_scam': 'Tech-support scam',
  'v3.scam.msg.type.customer_support_impersonation': 'Customer-support impersonation',
  'v3.scam.msg.type.loan_scam': 'Loan scam',
  'v3.scam.msg.type.charity_scam': 'Charity scam',
  'v3.scam.msg.type.other': 'Other scam pattern',
  // Attack goals (`AttackGoal`).
  'v3.scam.msg.goal.account_takeover': 'Take over your account',
  'v3.scam.msg.goal.credential_theft': 'Steal your login details',
  'v3.scam.msg.goal.otp_interception': 'Capture your OTP code',
  'v3.scam.msg.goal.payment_fraud': 'Get you to send money',
  'v3.scam.msg.goal.identity_theft': 'Steal your personal information',
  'v3.scam.msg.goal.malware_installation': 'Install malware on your device',
  'v3.scam.msg.goal.remote_access_compromise': 'Take remote control of your device',
  'v3.scam.msg.goal.phishing': 'Lure you to a fake page',
  'v3.scam.msg.goal.social_engineering': 'Manipulate you into complying',
  'v3.scam.msg.goal.investment_scam': 'Get you to deposit into a fake investment',
  'v3.scam.msg.goal.romance_scam': 'Exploit a relationship for money',
  'v3.scam.msg.goal.impersonation': 'Borrow a trusted name to gain your trust',
  'v3.scam.msg.goal.other': 'Other goal',
  // Official anti-fraud knowledge library — chrome only; scenario content stays in Vietnamese as published.
  'v3.scam.kb.title': 'Anti-fraud knowledge',
  'v3.scam.kb.subtitle': 'Common scam scenarios compiled from official sources.',
  'v3.scam.kb.all': 'All',
  'v3.scam.kb.official': 'Information from an official source',
  'v3.scam.kb.source': 'Source',
  'v3.scam.kb.openSource': 'Open the original source',
  'v3.scam.kb.published': 'Published',
  'v3.scam.kb.verifiedAt': 'Checked by TappyAI on',
  'v3.scam.kb.officialNumber': 'Scenario #{n} in the official list',
  'v3.scam.kb.guidance': 'TappyAI guidance',
  'v3.scam.kb.guidanceNote': 'Written by TappyAI from the official material — not a verbatim quotation.',
  'v3.scam.kb.signs': 'Warning signs',
  'v3.scam.kb.requests': 'What the scammer usually asks for',
  'v3.scam.kb.goal': "The scammer's goal",
  'v3.scam.kb.doNot': 'Do NOT',
  'v3.scam.kb.doNow': 'Do this',
  'v3.scam.kb.prevention': 'Prevention measures (from the official source)',
  'v3.scam.kb.report': 'If you spot a scam',
  'v3.scam.kb.showMore': 'Show more scenarios',
  'v3.scam.kb.showLess': 'Show less',
  'v3.scam.kb.close': 'Close',
  'v3.scam.kb.count': '{n} scenarios',
  'v3.scam.kb.contentLanguage': 'Scenario content is shown in Vietnamese, as published by the source.',
  'v3.scam.kb.cat.impersonation': 'Government & institutions',
  'v3.scam.kb.cat.ai_deepfake': 'AI – Deepfake',
  'v3.scam.kb.cat.investment_jobs': 'Investment & jobs',
  'v3.scam.kb.cat.online_trading': 'Online trading',
  'v3.scam.kb.cat.data_theft': 'Data theft',
