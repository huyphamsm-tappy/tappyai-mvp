...
export const dictionaries: Record<Locale, Record<string, string>> = {
  vi: {
    ...
    'settings.howToUse': 'Hướng dẫn sử dụng',
    ...
    'login.welcomeTo': 'Chào mừng đến với',
    'login.touchEvery': 'Chạm Đến Mọi Dịch Vụ',
    'login.personalAgent': 'AI Agent cá nhân của bạn',
    'login.f1Title': 'Trợ lý AI tất-cả-trong-một',
    'login.f1Desc': 'Chat, tìm kiếm, lên kế hoạch — xong hết trong một nơi.',
    'login.f2Title': 'Khám phá mọi thứ',
    'login.f2Desc': 'Du lịch, ẩm thực, review, âm nhạc — tất cả được kết nối.',
    'login.f3Title': 'Bảo mật & Riêng tư',
    'login.f3Desc': 'Dữ liệu thuộc về bạn. Chúng tôi bảo vệ quyền riêng tư của bạn.',
    'login.f4Title': 'Luôn bên bạn',
    ...
    'login.statServices': 'Dịch vụ thông minh',
    'login.statCities': 'Thành phố phủ sóng',
    'login.statUptime': 'Uptime & Bảo mật',
    ...
    'home.scamShieldTitle': 'Kiểm tra an toàn',
    'home.scamShieldDesc': 'Kiểm tra link, web, mã QR',
    ...
    'scamShield.checking': 'Đang kiểm tra...',
    'scamShield.qrUpload': 'Quét mã QR',
    'scamShield.qrCamera': 'Chụp ảnh QR',
    'scamShield.orScanQr': 'hoặc quét mã QR',
    'scamShield.result.safe': 'An toàn',
    'scamShield.result.low': 'Nguy cơ thấp',
    ...
    'scamShield.evidence': 'Chi tiết phân tích',
    'scamShield.actions': 'Khuyến nghị',
    'scamShield.official': 'Thông tin chính thức',
    'scamShield.official.website': 'Website chính thức',
    'scamShield.official.hotline': 'Hotline',
    'scamShield.error.invalidUrl': 'URL không hợp lệ',
    'scamShield.error.privateUrl': 'Không thể kiểm tra địa chỉ mạng nội bộ',
    'scamShield.error.rateLimit': 'Bạn đã kiểm tra quá nhiều lần. Thử lại sau.',
    'scamShield.error.dailyLimit': 'Đã hết lượt kiểm tra hôm nay. Quay lại ngày mai.',
    'scamShield.error.checkFailed': 'Không thể kiểm tra URL',
    'scamShield.error.qrDecode': 'Không thể đọc mã QR',
    'scamShield.error.qrNoUrl': 'Mã QR không chứa liên kết',
    'scamShield.error.qrFailed': 'Không thể kiểm tra mã QR',
  ...
  en: {
    ...
    'settings.howToUse': 'How to use TappyAI',
    ...
    'login.touchEvery': 'Touch Every Service',
    'login.personalAgent': 'Your Personal AI Agent',
    'login.f1Title': 'All-in-One AI Assistant',
    'login.f1Desc': 'Chat, search, plan, and get things done in one place.',
    'login.f2Title': 'Explore Everything',
    'login.f2Desc': 'Travel, food, reviews, music and more — all connected.',
    'login.f3Title': 'Secure & Private',
    'login.f3Desc': 'Your data belongs to you. We protect your privacy.',
    'login.f4Title': 'Always with You',
    ...
    'login.statServices': 'Smart Services',
    'login.statCities': 'Cities Covered',
    'login.statUptime': 'Uptime & Secure',
    ...
    'home.scamShieldTitle': 'Safety check',
    'home.scamShieldDesc': 'Check links, websites, QR codes',
    ...
    'scamShield.checking': 'Checking...',
    'scamShield.qrUpload': 'Scan QR',
    'scamShield.qrCamera': 'Capture QR',
    'scamShield.orScanQr': 'or scan a QR code',
    'scamShield.result.safe': 'Safe',
    'scamShield.result.low': 'Low risk',
    ...
    'scamShield.evidence': 'Analysis details',
    'scamShield.actions': 'Recommendations',
    'scamShield.official': 'Official information',
    'scamShield.official.website': 'Official website',
    'scamShield.official.hotline': 'Hotline',
    'scamShield.error.invalidUrl': 'Invalid URL',
    'scamShield.error.privateUrl': 'Cannot check internal network addresses',
    'scamShield.error.rateLimit': 'Too many checks. Try again later.',
    'scamShield.error.dailyLimit': 'Daily check limit reached. Come back tomorrow.',
    'scamShield.error.checkFailed': 'Could not check this URL',
    'scamShield.error.qrDecode': 'Could not read QR code',
    'scamShield.error.qrNoUrl': 'QR code does not contain a link',
    'scamShield.error.qrFailed': 'Could not check QR code',
