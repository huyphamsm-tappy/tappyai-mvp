...
const full: Record<Locale, Record<string, string>> = {
  vi: { ...dictionaries.vi, ...w2vi, ...w3vi, ...w4vi, ...w5vi, ...v3vi, ...w6vi, ...adminVi, ...landingVi, ...legalVi, ...shareVi, ...guideVi },
  en: { ...dictionaries.en, ...w2en, ...w3en, ...w4en, ...w5en, ...v3en, ...w6en, ...adminEn, ...landingEn, ...legalEn, ...shareEn, ...guideEn },
}
