...
export const metadata = {
  title: 'SuperTux — TappyAI Games',
  description: 'SuperTux — game platformer Mario-style mã nguồn mở (GPL license)',
}
  ...
  return (
    <div className="h-dvh bg-black flex flex-col overflow-hidden">
      ...
      <iframe
        ...
        title="SuperTux — open-source Mario-style platformer (GPL license)"
        allow="fullscreen"
      />
    </div>
  )
