...
// Marketing V1 FOUNDATION — promotions.
//
...
// `MARKETING_PROMOTIONS_READ` is refused here, server-side; the navigation card
...
export default async function MarketingPromotionsPage() {
  await requirePagePermission(PERMISSIONS.MARKETING_PROMOTIONS_READ)
  return <ModuleComingSoon titleKey="admin.nav.promotions" />
}
