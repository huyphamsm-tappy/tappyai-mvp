...
const SRC = readFileSync('src/app/(app)/planner/PlannerView.tsx', 'utf8')
const PAGE = readFileSync('src/app/(app)/planner/page.tsx', 'utf8')
...
describe('the empty states', () => {
  ...
  it('the page has no loading or error surface of its own to fake — the server component renders or redirects', () => {
    ...
    expect(existsSync('src/app/(app)/planner/loading.tsx')).toBe(false)
    expect(existsSync('src/app/(app)/planner/error.tsx')).toBe(false)
