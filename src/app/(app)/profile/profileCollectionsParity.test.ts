...
const WEB = {
  hub: 'src/app/(app)/profile/ProfileView.tsx',
  page: 'src/app/(app)/profile/page.tsx',
...
describe.skip('the five personal collections are the same list, in the same order, on all three platforms', () => {
...
describe.skip('every collection reads the same gated route on every platform', () => {
...
describe.skip('the collections are private: a guest sees a sign-in gate, a creator profile never asks', () => {
