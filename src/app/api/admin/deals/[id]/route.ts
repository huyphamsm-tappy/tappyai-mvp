...
const FULL_COLUMNS =
  'id, partner_name, category, title, description, official_url, banner_image, logo_image, display_order, is_active, start_at, end_at, country_code, created_at, updated_at'
