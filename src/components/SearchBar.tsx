      ...
      <>
        ...
        {showEmojiPanel && (
          <div
            ...
            style={panelStyle}
          >
            <p className="text-[10px] font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wide mb-2 px-0.5">
              Chọn biểu cảm
            </p>
        ...
        <form onSubmit={handleSubmit} className="relative">
          ...
          <input
            ...
            className="w-full bg-white dark:bg-gray-900 rounded-2xl pl-11 pr-[130px] py-4 text-gray-900 dark:text-gray-100 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-white/60 text-[15px] shadow-lg transition-all"
          />
  ...
  return (
    <form onSubmit={handleSubmit} className="relative">
      ...
      <input
        ...
        className="w-full bg-gray-100 dark:bg-gray-800 rounded-2xl pl-11 pr-4 py-3.5 text-gray-900 dark:text-gray-100 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-500/50 text-[15px] transition-all"
      />
      {query && (
