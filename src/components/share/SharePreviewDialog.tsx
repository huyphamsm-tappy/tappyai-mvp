...
export default function SharePreviewDialog({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-end sm:items-center justify-center bg-black/50 backdrop-blur-sm" role="dialog" aria-modal="true" aria-label={t('share.public.previewTitle')} onClick={onClose}>
      <div className="w-full sm:max-w-md max-h-[90dvh] overflow-y-auto rounded-t-2xl sm:rounded-2xl bg-white dark:bg-gray-900 p-5 shadow-xl" onClick={(e) => e.stopPropagation()}>
        <div className="mb-3 flex items-center justify-between">
          <h2 className="flex items-center gap-2 text-base font-semibold text-gray-900 dark:text-gray-50"><Eye size={16} /> {t('share.public.previewTitle')}</h2>
        ...
        <p className="mb-4 text-xs text-gray-500 dark:text-gray-400">{t('share.public.previewHint')}</p>
