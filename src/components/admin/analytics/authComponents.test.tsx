...
// English assertions, so the locale is stated rather than inherited — the product default is
// Vietnamese, and the English these tests used to get was jsdom's `navigator.language`.
