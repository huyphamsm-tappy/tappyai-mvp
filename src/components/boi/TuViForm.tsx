...
import { getCanChiByYear, getNguHanhByYear, CanChi } from '@/lib/boi/canChiData'
...
export default function TuViForm() {
      ...
      <form onSubmit={handleSubmit} className="card p-6 text-center space-y-5">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">
            Nhập ngày sinh (dương lịch) để xem con giáp và luận giải vận hạn của bạn.
          </p>
        </div>
  ...
  const reading = generateFortune(result.canChi.id, period, result.canChi.banks)
